...
public interface ISubscriptionController {
    ...
    public Subscription addSubscription(User user, Address address, LocalTime delivery_hour, DayOfWeek delivery_day);

    public Subscription editSubscription(Subscription subscription, User user, Address address, LocalTime delivery_hour, DayOfWeek delivery_day);
